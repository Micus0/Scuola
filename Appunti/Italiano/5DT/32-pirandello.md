...
- tra le due guerre
- famiglia alta locata
- si interessa al teatro
- va anche in germania
- matrimonio con antonietta
- romanzi a puntate (feuilleton)
- problemi
  - famiglia dissesto economico
    - miniera fallisce
  - moglie crisi nervose
- '22 novelle per un anno
- si dedica al teatro
  - e progetta una compagnia pubblica
- per avere fondi si iscrive al partito fascista
  - pubblica e solenne
  - mussolini aveva bisogno di agganci culturali
    - promette aiuti per i progetti d'arte
  - ma adesione tiepida
    - adesione non ideologica
    - rapporti non solidi
    - si intiepidiscono presto
  - controllato dall'ovra
  - alcuni fascisti non sono d'accordo con la sua idea7
    - p. randello
  - pirandello quando muore non voleva i funerali di stato
    - mussolini si
- si lega con un'attrice
  - relazione più platonica
- affida a mondadori diffusione sue opere
- '34 premio nobel per la letteratura


### 1 L'eresia catara

- autore tedesco sull'eresia catara
  - ma lo riprende poco
- Bernardino Lamis parla dell'eresia catara
- più fluida rispetto a svevo
- tante subordinate e sintassi ipotattica
  - tipico di questo periodo
- discorso indiretto libero
- l'immagine fa un po' ridere alla fine
  - riso ma un po' amaro (fa un po' pena)
- lamis:
  - ossessionato
  - incompreso
  - inetto?
    - fare lezione a due studenti, a dei cappotti (lo vedono come uno squilibrato)
    - però c'è chi lo ammira (vannicoli)
    - all'università
      - tutto rigido fama
    - il ciotta
    - la signora dove va a comprare le schiumette (normale)
    - ognuno da una visione della cosa
      - o tutti o nessuno
- presentazione personaggi in maniera granitica
  - **l'uomo non è una cosa soltanto**
- cause
  - psicoanalisi
  - nel suo teatro ribalta il sistema
    - impossibile rappresentare il reale
    - io che impersonifica altro io (impossibile)
  - società di massa
    - si perde l'individualità
  - relatività
    - tutto è relativo
  - la prima guerra
    - valore vita umana
  - burocratizzazione
    - spiazza elemento identità
    - solo un numero


### 2 Il treno ha fischiato (da leggere)

- rapp con eresia catara
  ...
  - lavoro-famiglia
  - come uscire
    - 1 lamis non ha capito
    - 2 belluca si
      - lasciatemi sentire il fischio ogni tanto
  - voce narrante
    - medias res
    - 2 il vicino


### L'umorismo e la scomposizione della realtà (147)

Sentimento del contrario
- comico: avvertimento del contrario
  - atto richiamare l'attenzione altrui su una cosa che è diversa dal normale
- umorismo: sentimento del contrario

Vita come flusso continuo
- parallelismo con treno a fischiato
  - belluca tenta di fermare la sua vita ma impazzisce
  - quando straripa sente il fischio
- la vita è un flusso continuo che noi cerchiamo di arrestare
- fossilizzarsi/cristallizzarsi da sé o da altri in un'identità che ci rassicura ma ci imprigiona/trappola (per non sbagliare)
  - noi siamo sempre in cambiamento
  - disequilibrio
- e quando non puoi uscire dalla trappola
  - dopo un po' va in crisi
  - belluca va in crisi
    - ora maschera del pazzo però ora ha capito
- forestiere della vita
  - vedo e capisco come funziona ma da lontano
- non condannare la vecchia maschera con quella di ora
  - siamo sempre in cambiamento
  - prima eri un'altra cosa


## Pensiero (142)

- crisi d'identità dell'uomo moderno
- concezione vitalistica della vita
  - tutto è in movimento
  - tutto è un divenire (eraclito)
  - flusso continuo (testo)
- tutto quello che si stacca dal flusso, si irrigidisce/cristallizza e muore
- perché si vuole identità coerente e unitaria
  - ma sistema di vivere che è un'illusione
  - si genera da quello che il mondo proietta davanti a noi
    - noi percezione e gli altri percezione
      - modi infiniti
- ci impone delle maschere (pirandelliane)
  - dietro le maschere si finisce di non rimanere nessuno
- io che si sgretola e si smarrisce
  - rifiuta l'idea di una realtà oggettiva??
  - nel momento della sgretolazione
    - dolore
  - --> sensazione di solitudine estrema
    - perdita dei punti di riferimento
- vita è un'enorme puppazzata (lettera verso la sorella)
  - pupi in siciliano: burattini
    - ognuno recita un ruolo
      - trappole
- famiglia opprimente
  - coacervo di sentimenti distruttivi
- lavoro
  - trappola economica
  - lavori monotoni/alienanti
  - gerarchia oppressiva
- necessità di inserirsi
- condizione universale
- strategie di salvezza: la follia
  - forestiere della vita
    - colui che ha capito il gioco
    - preso coscienza di questo meccanismo
    - si esclude e guarda gli uomini imprigionati
  - filosofia del lontano
    - leopardi guarda verso qualcosa di lontano
    - mentre priandello parte dal lontano
- c'è chi sfrutta la maschera a suo vantaggio
- treno a fischiato momento di apparizione
  - epifania
- ruolo arte
  - scompone realtà oggettiva e granitica
- critica alla meccanizzazione


### La patente Totò (filmato)

- trappole sociali
- licenziato
- la dote
- la maschera dell'aiettatore
  - sfrutta la maschera a suo vantaggio
- scaramanzia
  - avvertimento del contrario che diventa sentimento
    - es cade il lampadario


## Novelle per un anno (153)

- alcune nei paesini siciliani
- alcune cittadine
